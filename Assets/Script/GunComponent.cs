...
public class GunComponent : MonoBehaviour
{
    ...
    void Update()
    {
        // Detect when the player starts charging
        if (Input.GetButtonDown("Fire1"))
        {
            chargeTime = 0.0f;   // reset charge
            isCharging = true;
        }

        // While the player holds the button, accumulate charge
        ...
        // When the player releases the button, shoot the bullet
